...
class FiltersViewController: UIViewController, UITextFieldDelegate, UITableViewDataSource, UITableViewDelegate, SwitchCellDelegate
{
    ...
    weak var delegate:FiltersViewControllerDelegate? //delegate to simplify searching
    ...
    @IBAction func onSearchButton(_ sender: AnyObject)
    {
        ...
        filters["search"] = searchField.text as AnyObject?
        filters["location"] = locationField.text as AnyObject?
        
        //set filters array and use delegate to search
